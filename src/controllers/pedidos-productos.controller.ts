...
export class PedidosProductosController {
  ...
  async get(
    ...
    return this.pedidosRepository.Rproductos(id).get(filter);
  }
  ...
  async create(
    ...
    return this.pedidosRepository.Rproductos(id).create(productos);
  }
  ...
  async patch(
    ...
    return this.pedidosRepository.Rproductos(id).patch(productos, where);
  }
  ...
  async delete(
    ...
    return this.pedidosRepository.Rproductos(id).delete(where);
  }
}
