...
export class PersonaPedidosController {
  ...
  async find(
    ...
    return this.personaRepository.Rpedidos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.Rpedidos(id).create(pedidos);
  }
  ...
  async patch(
    ...
    return this.personaRepository.Rpedidos(id).patch(pedidos, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.Rpedidos(id).delete(where);
  }
}
